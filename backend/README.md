...
## Project Structure
    ...
    ├── testapiautoconnect_104138  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_104138`
...
2. Clone this repo and `cd testapiautoconnect_104138`
